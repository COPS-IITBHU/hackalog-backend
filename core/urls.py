...
urlpatterns = [
    ...
    path('hackathons/<slug:slug>/', HackathonsRUDView.as_view(), name='Hackathon Read, Edit and Delete View'),
    path('hackathons/<int:pk>/teams/join/<str:team_id>/', JoinTeamView.as_view()),
    path('hackathons/<slug:slug>/submissions/', HackathonSubmissionView.as_view()),
